            ...
            <article className="relative">
              ...
              <h2 className="font-medium absolute left-5 bottom-5">{product.name}</h2>
              {
                product.variants.length > 1
                  ?
                  <p className="font-medium absolute right-5 bottom-5">{product.variants.length} variants from ${product.variants[0].price}</p>
                  :
                  <p className="font-medium absolute right-5 bottom-5">${product.variants[0].price}</p>
              }
            </article>
          </li>
        ) )}
