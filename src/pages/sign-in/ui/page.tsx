      ...
      <fieldset disabled={navigation.formAction === '/signin'}>
        ...
        <div className="mt-8">
          <div className="relative">
            ...
            <label htmlFor="email" className="absolute top-1/2 left-4 -translate-y-1/2">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-[#C2C3CB] peer-focus:fill-black" aria-hidden="true">
                <title>Email</title>
        ...
        <div className="mt-5">
          <div className="relative">
            ...
            <label htmlFor="password" className="absolute top-1/2 left-4 -translate-y-1/2">
              <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-4 h-4 fill-[#C2C3CB] peer-focus:fill-black" aria-hidden="true">
        ...
        <button title="Sign in" className="w-full mt-5 p-3.5 rounded-xl bg-black text-white cursor-pointer outline-offset-3">Sign in</button>
      </fieldset>
